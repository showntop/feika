...
(function (UIEventType) {
    UIEventType["RESOURCE_UPDATE"] = "ui_resource_update";
    UIEventType["ITEM_CLICK"] = "ui_item_click";
    UIEventType["ITEM_MERGE"] = "ui_item_merge";
    UIEventType["GENERATOR_CLICK"] = "ui_generator_click";
    UIEventType["ORDER_COMPLETE"] = "ui_order_complete";
    UIEventType["DIALOG_NEXT"] = "ui_dialog_next";
    UIEventType["DIALOG_SKIP"] = "ui_dialog_skip";
    UIEventType["PANEL_TOGGLE"] = "ui_panel_toggle";
...
export class UIManager {
    ...
    setupEventListeners() {
        ...
        const listenerConfigs = [
            ...
            // UI内部事件
            { event: UIEventType.ITEM_CLICK, handler: (data) => this.handleItemClick(data) },
            { event: UIEventType.ITEM_MERGE, handler: (data) => this.handleItemMerge(data) },
            { event: UIEventType.GENERATOR_CLICK, handler: (data) => this.handleGeneratorClick(data) },
