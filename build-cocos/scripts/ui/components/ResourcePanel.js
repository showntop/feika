...
export class ResourcePanel extends BaseComponent {
    constructor() {
        ...
        this.reputationAnimation = null;
        this.connectionsAnimation = null;
        this.energyAnimation = null;
     ...
     * 处理现金变化
     */
    handleCashChange(current, previous) {
     ...
     * 处理口碑变化
     */
    handleReputationChange(current, previous) {
        const change = current - previous;
     ...
     * 处理人脉变化
     */
    handleConnectionsChange(current, previous) {
        const change = current - previous;
     ...
     * 处理体力变化
     */
    handleEnergyChange(current, max) {
     ...
     * 显示资源变化动画
     */
    showResourceChange(resourceType, change) {
