 ...
 * @returns 实际运行时路径
 */
export function resolveModulePath(alias: string): string {
...
export class ModuleImporter {
    private static instance: ModuleImporter;
    private cache: Map<string, any> = new Map();

    private constructor() {}

    public static getInstance(): ModuleImporter {
     ...
     * @returns 模块导出
     */
    public import(alias: string): any {
 ...
 * 全局模块导入助手
 */
export const importModule = (alias: string): any => {
