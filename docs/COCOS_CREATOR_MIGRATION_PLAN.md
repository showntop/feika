...
### 技术目标
- **引擎**: Cocos Creator 3.8 (推荐) 或更高版本
- **语言**: TypeScript 5.x
- **目标平台**: 微信小游戏（主）、抖音小游戏（备选）
- **包体积**: < 4MB（微信小游戏限制）

### 🔧 重要版本说明
**请使用 Cocos Creator 3.x 版本打开本项目**

由于项目已配置为 Cocos Creator 3.8 格式：
- `project.json` 配置为 Cocos Creator 3.x 项目结构
- TypeScript 配置支持 ES2020 和装饰器语法
- 场景文件使用 3.x 格式

如果同时出现 2.x 和 3.x 选项，**请选择 3.x 版本**。
